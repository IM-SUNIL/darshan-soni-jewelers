...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative py-20 px-4 sm:px-8 lg:px-16 bg-gradient-to-br from-pink-50 via-yellow-50 to-gold/10 dark:from-black dark:via-gold/10 dark:to-yellow-900 animate-gradient transition-colors duration-500 rounded-3xl shadow-2xl max-w-4xl mx-auto mt-10 mb-10">
      <div className="max-w-2xl mx-auto text-center">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gold mb-8 tracking-tight drop-shadow-lg">Contact Us</h2>
