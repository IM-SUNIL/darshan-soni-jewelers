export default function About() {
  return (
    <section id="about" className="relative py-20 px-4 sm:px-8 lg:px-16 bg-gradient-to-br from-yellow-50 via-pink-50 to-gold/10 dark:from-black dark:via-gold/10 dark:to-yellow-900 animate-gradient transition-colors duration-500 rounded-3xl shadow-2xl max-w-5xl mx-auto mt-10 mb-10">
      <div className="max-w-3xl mx-auto text-center">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gold mb-6 tracking-tight drop-shadow-lg">About Us</h2>
        <p className="text-lg sm:text-xl md:text-2xl text-gray-700 dark:text-white/90 leading-relaxed font-medium mb-6">
